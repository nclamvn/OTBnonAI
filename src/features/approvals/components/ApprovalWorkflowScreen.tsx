    ...
    <div className="space-y-2 md:space-y-3">
      ...
      {loading ? (
        ...
        isMobile ? (
          ...
          <div className="space-y-2">
            {steps.length === 0 ? (
              <div className={`rounded-xl border p-8 text-center ${darkMode ? 'bg-[#121212] border-[#2E2E2E]' : 'bg-white border-[#C4B5A5]'}`}>
                <p className={`text-xs font-['Montserrat'] ${darkMode ? 'text-[#999999]' : 'text-[#666666]'}`}>
              ...
              steps.map((step: any) => (
                ...
                >
                  {step.user && (
                    <div className={`mt-2 flex items-center gap-1.5 text-xs font-['Montserrat'] ${darkMode ? 'text-[#999999]' : 'text-[#666666]'}`}>
                      <Users size={12} />
        ...
        <div className="space-y-2 md:space-y-3">
          {Object.entries(stepsByBrand).map(([brandName, brandSteps]: any) => (
            <div key={brandName} className={`rounded-xl border p-3 md:p-4 ${
              darkMode ? 'border-[#2E2E2E]' : 'border-[#C4B5A5]'
            }`} style={{
              background: darkMode
                ? 'linear-gradient(135deg, #121212 0%, rgba(215,183,151,0.02) 40%, rgba(215,183,151,0.06) 100%)'
                    ...
                    <div key={step.id}>
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 flex-shrink-0 ${
                          ...
                          <span className={`font-bold text-sm font-['JetBrains_Mono'] ${darkMode ? 'text-[#D7B797]' : 'text-[#6B4D30]'}`}>{step.stepNumber}</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className={`text-sm font-medium font-['Montserrat'] ${darkMode ? 'text-[#F2F2F2]' : 'text-[#0A0A0A]'}`}>
                            {step.roleName}
                          </span>
                          {step.description && (
                            <p className={`text-xs font-['Montserrat'] truncate ${darkMode ? 'text-[#999999]' : 'text-[#666666]'}`}>
                              {step.description}
                            </p>
                          )}
                        </div>
                      ...
                      {index < brandSteps.length - 1 && (
                        <div className="flex justify-center py-0.5">
                          <ChevronRight size={16} className={`rotate-90 ${darkMode ? 'text-[#2E2E2E]' : 'text-[#2E2E2E]/30'}`} />
                        </div>
                      )}
                    </div>
                  ))}
          ...
          {Object.keys(stepsByBrand).length === 0 && (
            <div className={`p-8 md:p-16 text-center rounded-xl border ${
              darkMode ? 'bg-[#121212] border-[#2E2E2E]' : 'bg-white border-[#C4B5A5]'
            }`}>
              <Settings size={isMobile ? 36 : 48} className={`mx-auto mb-4 ${darkMode ? 'text-[#2E2E2E]' : 'text-[#2E2E2E]/30'}`} />
      ...
      {isModalOpen && (
        <div className={`fixed inset-0 bg-black/60 backdrop-blur-sm flex ${isMobile ? 'items-end' : 'items-center'} justify-center z-50`} onClick={() => setIsModalOpen(false)}>
          <div
            className={`w-full ${isMobile ? 'rounded-t-2xl max-h-[90vh] overflow-y-auto' : 'rounded-2xl max-w-md m-4'} p-4 md:p-6 shadow-2xl ${
          ...
          >
            ...
            {isMobile && (
              <div className="flex justify-center mb-3">
                <div className={`w-10 h-1 rounded-full ${darkMode ? 'bg-[#2E2E2E]' : 'bg-[#C4B5A5]'}`} />
              </div>
            )}

            <div className="flex items-center justify-between mb-4 md:mb-6">
              <h2 className={`text-lg md:text-xl font-bold font-['Montserrat'] ${darkMode ? 'text-[#F2F2F2]' : 'text-[#0A0A0A]'}`}>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-0.5 border rounded-lg text-sm font-['Montserrat'] focus:outline-none focus:ring-2 focus:ring-[#D7B797] disabled:opacity-50 ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-0.5 border rounded-lg text-sm font-['JetBrains_Mono'] focus:outline-none focus:ring-2 focus:ring-[#D7B797] ${
                    darkMode ? 'bg-[#1A1A1A] border-[#2E2E2E] text-[#F2F2F2]' : 'bg-white border-[#C4B5A5] text-[#0A0A0A]'
                  }`}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-0.5 border rounded-lg text-sm font-['Montserrat'] focus:outline-none focus:ring-2 focus:ring-[#D7B797] ${
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-3 mt-4 md:mt-6">
              <button
                onClick={() => setIsModalOpen(false)}
                className={`flex-1 px-4 py-0.5 border rounded-lg font-medium text-sm font-['Montserrat'] transition-colors ${
